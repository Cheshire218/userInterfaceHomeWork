				...
				case (int)OptionsMenuItems.Video:
					{
						...
						Main.Instance.LangManager.Text("OptionsMenuItems", "Video"));
				...
				case (int)OptionsMenuItems.Sound:
					{
						var tempControl =
						CreateControl(Interface.InterfaceResources.ButtonPrefab,
						Main.Instance.LangManager.Text("OptionsMenuItems", "Sound"));
				...
				case (int)OptionsMenuItems.Back:
					{
						var tempControl =
						CreateControl(Interface.InterfaceResources.ButtonPrefab,
						Main.Instance.LangManager.Text("OptionsMenuItems", "Back"));
